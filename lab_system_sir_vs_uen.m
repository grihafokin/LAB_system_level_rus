...
udn.accuracy=3;              % диаметр зоны местоположения UE, м

udn.int_intrasec=1;           % 1 - учет внутрисекторных помех, 0 - нет 
...
UE_num=[1:1:64];                % число устройств на сектор соты
...
grid on; axis('tight'); ylabel('SINR, дБ'); xlabel('K пользовательских устройств');
...
axis('tight'); ylabel('HPBW, \circ'); xlabel('K пользовательских устройств');
