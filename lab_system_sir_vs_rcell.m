...
udn.angle_min=1;              % минимальное значение hpbw, градусы
...
grid on; axis('tight'); ylabel('SINR, дБ'); xlabel('R, м');
...
axis('tight'); ylabel('HPBW, \circ'); xlabel('R, м');
